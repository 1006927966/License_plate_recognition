...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3,
        ...
        if use_se:
            ...
            self.se = nn.Identity()# 不改变输入，直接返回input。属于占位公式
    ...
    '''
    将卷积和bn融合成新的卷积，并将不同kernel卷积转化成3x3
    '''
    ...
    '''
    Train 模式改成 推理模式，将三中卷积和bn都变成3x3卷积
    '''
